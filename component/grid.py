...
class Grid:
    ...
    def random_cell(self):
        ...
        return self.record[r][c] if self.record else None
    ...
    def configure_cell(self):
        for cell in self.each_cell():
            ...
            cell.north = self.record[r-1][c] if 0 < r else None
            cell.south = self.record[r+1][c] if r+1 < self.row_dim else None
            cell.west = self.record[r][c-1] if 0 < c else None
            cell.east = self.record[r][c+1] if c+1 < self.col_dim else None
